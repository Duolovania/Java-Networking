...
public class UI
{
     ...
     */
    public static JLabel NorthWestAnchor(String text, int hPad, int vPad, SpringLayout layout, Component other)
    {
     ...
     * @return A completed and setup JLabel ready to be added to a Frame
     */
    public static JLabel InlineToRight(String text, int hPad, SpringLayout layout, Component other)
    {
        // Create a new label object with the specified text displayed on it.
        JLabel myLabel = new JLabel(text);
        // Constrain the vertical and horizontal positions of the label
    ...
    /**
     * Takes a provided JScrollPane and configures it based upon the provided parameters using a Spring Layout system.
     * The label will be positioned by the spring layout to be inline horizontally and to the direct right to
     * a designated component.
     *
     * @param textArea The text to be printed to the label
     * @param hPad The horizontal padding distance between the 2 objects
     * @param layout The spring layout object used for positioning
     * @param other The component which the label will be located in association to.
     *
     * @return A completed and setup JLabel ready to be added to a Frame
     */
    public static JScrollPane InlineToRight(JTextArea textArea, int hPad, SpringLayout layout, Component other)
    {
        ...
        scroll.setPreferredSize(new Dimension(185,50));
        ...
        layout.putConstraint(SpringLayout.WEST, scroll, hPad, SpringLayout.EAST, other);
        layout.putConstraint(SpringLayout.NORTH, scroll, 4, SpringLayout.NORTH, other);
        return scroll;
    }
     ...
     * @return A completed and setup JLabel ready to be added to a Frame
     */
    public static JLabel InlineBelow(String text, int vPad, SpringLayout layout, Component other)
    {
        // Create a new label object with the specified text displayed on it.
        JLabel myLabel = new JLabel(text);
        // Constrain the vertical and horizontal positions of the label
     ...
     */
    public static JTextField NorthWestAnchor(int size,int hPad,int vPad,SpringLayout layout,Component other)
    {
     ...
     * @return A completed and setup TJextField ready to be added to a Frame
     */
    public static JTextField InlineToRight(int size,int hPad,SpringLayout layout,Component other)
    {
        // Create a new text field object with the specified text size. The size is based upon a column width principal where each
        // column is equivalent to a lower case m in size.
        JTextField myTextField = new JTextField(size);
     ...
     * @return A completed and setup TJextField ready to be added to a Frame
     */
    public static JTextField InlineBelow(int size,int vPad,SpringLayout layout,Component other)
    {
        // Create a new text field object with the specified text size. The size is based upon a column width principal where each
        // column is equivalent to a lower case m in size.
        JTextField myTextField = new JTextField(size);
     ...
     * @return
     */
    public static JButton NorthWestAnchor(int width, int height, String text, int hPad, int vPad,
     ...
     * @return
     */
    public static JButton InlineToRight(int width, int height, String text, int hPad,
                                                    ActionListener listener, SpringLayout layout, Component other)
    {
        // Create a new button object with the specified text displayed on it.
        JButton myButton = new JButton(text);
     ...
     * @return
     */
    public static JButton InlineBelow(int width, int height, String text, int vPad, ActionListener listener, SpringLayout layout, Component other)
    {
        // Create a new button object with the specified text displayed on it.
        JButton myButton = new JButton(text);
        //Sets the preferred size of the component by providing it a Dimension object with e height and width value.
